        ...
        <div class="row-posts" >
          <div class="card-posts col-md-3 col-12" data-aos="fade-up">
            <div class="card-content">
              <div class="card-body"> <img class="img" src="https://i.imgur.com/S7FJza5.png" alt='' />
          ...
          <div class="card-posts col-md-3 col-12 ml-2" data-aos="fade-up">
            <div class="card-content">
              <div class="card-body"> <img class="img" src="https://i.imgur.com/xUWJuHB.png" alt='' />
          ...
          <div class="card-posts col-md-3 col-12 ml-2" data-aos="fade-up">
            <div class="card-content">
              <div class="card-body"> <img class="img rck" src="https://i.imgur.com/rG3CGn3.png" alt='' />
